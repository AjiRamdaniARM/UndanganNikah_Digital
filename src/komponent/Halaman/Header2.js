...
export const Header2 = () => {
    ...
    return(
        <div className='Header2'>
            <div className='lg:p-10 w-full p-3' >
            <center>
            <div className='container  lg:max-w-xl max-w-sm  card bg-white/50  lg:w-full  rounded-xl p-5  '>
                ...
                <div className='container'>
                    ...
                    <p className='w-full mt-4'>Tanpa mengurangi rasa hormat,
                ...
                <div className="Text-Nama ">
                    {dataOrang && dataOrang.map(({namaPanjangPerempuan, namaBapakPr, namaIbuPr, namaBapakLaki,namaIbuLaki,namaPanjangLaki}) => (
                        ...
                        <p style={{fontFamily: "Montserrat-bold"}}>Putri dari {namaBapakPr} & {namaIbuPr}  </p>
